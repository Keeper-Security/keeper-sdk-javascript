...
export enum PamErrorCode {
    RotateTargetRequired = 'pam_rotate_target_required',
    RotateFolderNotFound = 'pam_rotate_folder_not_found',
    RotatePostProcessingUnsupported = 'pam_rotate_post_processing_unsupported',
    ConnectionRecordRequired = 'pam_connection_record_required',
    ConnectionRecordAmbiguous = 'pam_connection_record_ambiguous',
    ...
    ConnectionConfigurationInvalid = 'pam_connection_configuration_invalid',
    ConnectionProtocolInvalid = 'pam_connection_protocol_invalid',
    ConnectionPortInvalid = 'pam_connection_port_invalid',
    ConnectionSettingsInvalid = 'pam_connection_settings_invalid',
    RbiRecordRequired = 'pam_rbi_record_required',
    RbiRecordAmbiguous = 'pam_rbi_record_ambiguous',
    RbiRecordNotFound = 'pam_rbi_record_not_found',
    RbiRecordInvalid = 'pam_rbi_record_invalid',
    RbiConfigurationRequired = 'pam_rbi_configuration_required',
    RbiAudioInvalid = 'pam_rbi_audio_invalid',
...
export const ResultCodes = {
    PAM_ROTATE_TARGET_REQUIRED: PamErrorCode.RotateTargetRequired,
    PAM_ROTATE_FOLDER_NOT_FOUND: PamErrorCode.RotateFolderNotFound,
    PAM_ROTATE_POST_PROCESSING_UNSUPPORTED: PamErrorCode.RotatePostProcessingUnsupported,
    PAM_CONNECTION_RECORD_REQUIRED: PamErrorCode.ConnectionRecordRequired,
    PAM_CONNECTION_RECORD_AMBIGUOUS: PamErrorCode.ConnectionRecordAmbiguous,
    PAM_CONNECTION_RECORD_NOT_FOUND: PamErrorCode.ConnectionRecordNotFound,
    PAM_CONNECTION_CONFIGURATION_REQUIRED: PamErrorCode.ConnectionConfigurationRequired,
    PAM_CONNECTION_CONFIGURATION_INVALID: PamErrorCode.ConnectionConfigurationInvalid,
    PAM_CONNECTION_PROTOCOL_INVALID: PamErrorCode.ConnectionProtocolInvalid,
    PAM_CONNECTION_PORT_INVALID: PamErrorCode.ConnectionPortInvalid,
    PAM_CONNECTION_SETTINGS_INVALID: PamErrorCode.ConnectionSettingsInvalid,
    PAM_RBI_RECORD_REQUIRED: PamErrorCode.RbiRecordRequired,
    PAM_RBI_RECORD_AMBIGUOUS: PamErrorCode.RbiRecordAmbiguous,
    PAM_RBI_RECORD_NOT_FOUND: PamErrorCode.RbiRecordNotFound,
    PAM_RBI_RECORD_INVALID: PamErrorCode.RbiRecordInvalid,
    PAM_RBI_CONFIGURATION_REQUIRED: PamErrorCode.RbiConfigurationRequired,
    PAM_RBI_AUDIO_INVALID: PamErrorCode.RbiAudioInvalid,
