...
export enum PamErrorCode {
    RouterUnavailable = 'pam_router_unavailable',
    ...
    ConfigInitUnavailable = 'pam_config_init_unavailable',
...
export const ResultCodes = {
    ...
    PAM_ROUTER_UNAVAILABLE: PamErrorCode.RouterUnavailable,
    ...
    PAM_CONFIG_INIT_UNAVAILABLE: PamErrorCode.ConfigInitUnavailable,
