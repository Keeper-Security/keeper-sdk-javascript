...
export const ACTION_REPORT_COLUMN_ORDER: readonly ActionReportColumn[] =
...
export const ACTION_STATUS_EVENT_TYPES: Readonly<
  Record<TargetUserStatus, readonly string[]>
> = {
  [TargetUserStatus.NoLogon]: [
    "login",
    "login_console",
    "chat_login",
    "accept_invitation",
  ...
  [TargetUserStatus.NoRecovery]: [
    "change_security_question",
    "account_recovery_setup",
  ],
};

export const ACTION_DEFAULT_DAYS_BY_TARGET: Partial<
  Record<TargetUserStatus, number>
> = {
...
export const ACTION_COLUMN_LABELS: Readonly<
  Record<ActionReportColumn, string>
> = {
...
export const PASSWORD_BREACHWATCH_STATUS_NAMES: Readonly<
