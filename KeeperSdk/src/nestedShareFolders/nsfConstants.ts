...
export const NSF_SENSITIVE_FIELD_TYPES = new Set([
  "password",
  "secret",
  "pinCode",
]);
export const NSF_NOTE_FIELD_TYPES = new Set(["note", "multiline"]);
export const NSF_TOP_LEVEL_FIELD_TYPES = new Set([
  "login",
  "password",
  "url",
  "note",
...
export const NSF_UNKNOWN_RECORD_TITLES = new Set([
  "(no data)",
  "(untitled)",
  "Unknown",
]);
...
export const NSF_LIST_TABLE_HEADERS = [
  "#",
  "Item Type",
  "UID",
  "Title",
...
export const NSF_FOLDER_COLORS = [
  "none",
  "red",
  "orange",
  "yellow",
...
export type NsfRecordPermissionRole =
  (typeof NSF_RECORD_PERMISSION_ROLES)[number];
export type NsfRecordPermissionRoleInput =
...
export const NSF_RECORD_PERMISSION_ROLE_MAP: Record<
  string,
  Folder.AccessRoleType
> = {
...
export const NSF_SHARE_EXPIRATION_RE =
...
export function getFolderPermissionsForRole(
  roleType: Folder.AccessRoleType,
): Folder.IFolderPermissions {
