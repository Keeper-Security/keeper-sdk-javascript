...
function buildNodeNotFoundMessage(
...
export function resolveParentNode(
  ...
  const byExactName = nodes.filter(
...
export function applyDecryptedNodeNames(
  nodes: EnterpriseNode[],
...
export function parentNeedsNameLookup(
