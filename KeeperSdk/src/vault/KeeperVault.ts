...
export class KeeperVault {
  ...
  public async getAccountUsername(): Promise<string | undefined> {
    return (
      this.sessionManager.getLastUsername() ?? this.auth?.username ?? undefined
    );
  }

  public async getWhoamiInfo(options?: {
    includeVaultCounts?: boolean;
  }): Promise<WhoamiInfo> {
    ...
    if (!summary) {
      throw new KeeperSdkError(
        "Account summary is unavailable.",
  ...
  public getRecordByUid(uid: string): DRecord | undefined {
    ...
    return this.getRecords().find(
      (record) => record.uid?.toLowerCase() === lower,
    );
  }
  ...
  public async deleteRecord(uidOrTitle: string): Promise<DeleteRecordResult> {
    const auth = this.getAuthOrThrow();
    const record =
      this.getRecordByUid(uidOrTitle) || this.findRecord(uidOrTitle);
    if (!record?.uid) {
      return {
  ...
  public formatListNsfTable(
    ...
    return this.nestedShareFolderManager.formatListNsfTable(
      rows,
      options ?? {},
    );
  }
  ...
  public renderListNsfAsciiTable(
    ...
    return this.nestedShareFolderManager.renderListNsfAsciiTable(
      table,
      options ?? {},
    );
  }
  ...
  public async getNestedShareFolder(
    ...
    return this.nestedShareFolderManager.getNestedShareFolder(
      identifier,
      options ?? {},
    );
  }
  ...
  public formatNsfDetail(result: GetNsfResult, verbose?: boolean): string {
    return this.nestedShareFolderManager.formatNsfDetail(
      result,
      verbose ?? false,
    );
  }
  ...
  public async linkNestedShareRecord(
    ...
    const result = await this.nestedShareFolderManager.linkNestedShareRecord(
      recordIdentifier,
      folderIdentifier,
    );
    if (result.success) await this.syncIfNeeded();
  ...
  public async removeNestedShareRecords(
    ...
    const result =
      await this.nestedShareFolderManager.removeNestedShareRecords(input);
  ...
  public async updateNestedShareFolder(
    ...
    const result =
      await this.nestedShareFolderManager.updateNestedShareFolder(input);
  ...
  public async updateNestedShareFolders(
    ...
    const result =
      await this.nestedShareFolderManager.updateNestedShareFolders(updates);
  ...
  public async shareNestedShareFolder(
    ...
    const result =
      await this.nestedShareFolderManager.shareNestedShareFolder(input);
  ...
  public async shareNestedShareRecord(
    ...
    const result =
      await this.nestedShareFolderManager.shareNestedShareRecord(input);
    if (
      !result.dryRun &&
  ...
  public async keepNsfShortcut(
    ...
    const defaultFolderUid =
      current && isNestedShareFolder(this.storage, current)
        ? current
        : undefined;
    const result = await this.nestedShareFolderManager.keepNsfShortcut(
      input,
      defaultFolderUid,
    );
    if (
  ...
  public formatKeepNsfShortcutPlan(
    result: KeepNsfShortcutResult,
  ): string {
  ...
  public async transferNestedShareRecords(
    ...
    const result =
      await this.nestedShareFolderManager.transferNestedShareRecords(input);
    if (result.success) await this.syncIfNeeded();
    return result;
  }
  ...
  public formatTransferNestedShareRecordResults(
    ...
    return this.nestedShareFolderManager.formatTransferNestedShareRecordResults(
      results,
    );
  }
  ...
  public formatRemoveNsfFolderPreview(
    ...
    return this.nestedShareFolderManager.formatRemoveNsfFolderPreview(
      preview,
      operation,
      quiet,
    );
  ...
  public formatNsfRecordDetailsOutput(
    ...
    return this.nestedShareFolderManager.formatNsfRecordDetailsOutput(
      result,
      format,
    );
  }
  ...
  public async updateNestedShareRecordPermissions(
    ...
    const result =
      await this.nestedShareFolderManager.updateNestedShareRecordPermissions(
        input,
      );
    if (result.confirmed) await this.syncIfNeeded();
    return result;
  ...
  public formatNsfRecordPermissionFailures(
    ...
    return this.nestedShareFolderManager.formatNsfRecordPermissionFailures(
      failures,
      kind,
    );
  }
