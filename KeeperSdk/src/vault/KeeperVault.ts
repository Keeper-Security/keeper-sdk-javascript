...
export class KeeperVault {
  ...
  public findRecord(uidOrTitle: string): DRecord | undefined {
    ...
    return this.getRecords().find(
      (r) => getRecordTitle(r).toLowerCase() === needle,
    );
  }
  ...
  public getWorkingFolderDisplayName(): string {
    return getWorkingFolderDisplayName(
      this.storage,
      this.folderSession.currentFolderUid,
    );
  }
  ...
  public async renameFolder(
    ...
    const auth = this.getAuthOrThrow();
    const result = await renameFolderOp(
      auth,
      this.storage,
      this.folderSession,
      folderPath,
  ...
  public async updateSharedFolderPermissions(
    ...
    const auth = this.getAuthOrThrow();
    const result = await updateSharedFolderPermissionsOp(
      auth,
      this.storage,
      sharedFolderUid,
      permissions,
  ...
  public async deleteVaultObjects(
    ...
    const auth = this.getAuthOrThrow();
    const result = await deleteVaultObjectsOp(
      auth,
      this.storage,
      refs,
      confirm ?? null,
