...
export class FolderManager {
  ...
  public async resolveSingleFolder(
    folderName: string,
  ...
  public async updateSharedFolderPermissions(
    ...
    return updateSharedFolderPermissions(
      this.requireAuth(),
      this.storage,
      sharedFolderUid,
      permissions,
  ...
  public async resolveRmdirPatternsToFolderUids(
    pattern: string,
  ): Promise<Set<string>> {
    return resolveRmdirPatternsToFolderUids(
      this.storage,
      this.session,
      pattern,
    );
