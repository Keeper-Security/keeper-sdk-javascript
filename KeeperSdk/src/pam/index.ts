...
export type { AuthProvider as ActionAuthProvider, PamRotateActionPayload } from './action'
export type {
...
export type {
    AuthProvider as ConnectionAuthProvider,
...
export type { AuthProvider as RbiAuthProvider, PamRbiEditInput, PamRbiEditResult, PamRbiSetting } from './rbi'
