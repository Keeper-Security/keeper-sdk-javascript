...
const DELETE_USER_INCLUDES: EnterpriseDataInclude[] = [
...
export async function deleteUsers(
  ...
  if (rawEmails.length === 0) {
    throw new KeeperSdkError(
      ...
      ResultCodes.NO_USERS_TO_DELETE,
    );
  }
...
export function formatDeleteUserResult(
...
export function renderDeleteUserAsciiTable(
  table: FormattedDeleteUserTable,
): string {
