...
import { getRecordCategory, getRecordDescription, getRecordTitle, getRecordType } from './RecordUtils'
...
export function formatRecordsListTable(
    ...
    const headers = ['#', 'Record uid', 'Type', 'Title', 'Description', 'Shared', 'Record category']
