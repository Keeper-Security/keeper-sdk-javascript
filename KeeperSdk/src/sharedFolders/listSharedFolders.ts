...
function countTeamsForFolder(
  ...
  return countBySharedFolderUid(
    storage.getAll<DSharedFolderTeam>("shared_folder_team"),
    sharedFolderUid,
  );
}
...
function countUsersForFolder(
  ...
  return countBySharedFolderUid(
    storage.getAll<DSharedFolderUser>("shared_folder_user"),
    sharedFolderUid,
  );
}
...
function countRecordsForFolder(
  ...
  return countBySharedFolderUid(
    storage.getAll<DSharedFolderRecord>("shared_folder_record"),
    sharedFolderUid,
  );
}
...
export function renderSharedFoldersAsciiTable(
  ...
  const ruleLine = Array.from({ length: colCount }, (_, c) =>
    "-".repeat(colWidths[c]),
  )
