...
| Package                                               | Purpose                                                                         |
| ----------------------------------------------------- | ------------------------------------------------------------------------------- |
| [`@keeper-security/keeper-sdk-javascript`](KeeperSdk) | High-level vault and enterprise API (`KeeperVault`) for Node.js and the browser |
...
- **Node.js**: 20 LTS or newer (examples target Node 20+; also check the `engines` field on `@keeper-security/keeperapi`)
...
Build **keeperapi** before **KeeperSdk** (the SDK depends on keeperapi):
...
- [`KeeperSdk/README.md`](KeeperSdk/README.md) — high-level package quickstart
