...
// This function is to create a test team. This function will not be used to create teams in the sdk.
...
async function createTeamRSA() {
    ...
    return {
        teamUid: uid,
        name: 'testname' + uid,
        teamKey: new Uint8Array([
            37, 8, 39, 101, 231, 83, 232, 101, 248, 53, 209, 18, 23, 159, 239, 133, 22, 154, 40, 237, 145, 233, 50, 41,
            119, 79, 136, 237, 49, 138, 232, 62, 207, 7, 106, 202, 211, 125, 167, 196, 86, 194, 201, 109, 125, 45, 149,
            179, 230, 253, 67, 27, 229, 84, 171, 61, 221, 120, 254, 95, 203, 75, 99, 229,
        ]), //(Uint8Array|null);
