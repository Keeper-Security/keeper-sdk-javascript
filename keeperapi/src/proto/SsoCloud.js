...
export const SsoCloud = $root.SsoCloud = (() => {
    ...
    SsoCloud.SsoCloudConfigurationRequest = (function() {
        ...
        SsoCloudConfigurationRequest.verify = function verify(message, long) {
            ...
            if (message.ssoCloudSettingAction != null && Object.hasOwnProperty.call(message, "ssoCloudSettingAction")) {
                if (!Array.isArray(message.ssoCloudSettingAction))
                    return "ssoCloudSettingAction: array expected";
                for (let i = 0; i < message.ssoCloudSettingAction.length; ++i) {
                    let error = $root.SsoCloud.SsoCloudSettingAction.verify(message.ssoCloudSettingAction[i], long + 1);
                    if (error)
    ...
    SsoCloud.SsoSharedConfigItem = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SsoSharedConfigItem.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SsoSharedConfigItem.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        SsoSharedConfigItem.verify = function verify(message, long) {
            ...
            if (message.ssoServiceProviderId != null && Object.hasOwnProperty.call(message, "ssoServiceProviderId"))
                if (!$util.isInteger(message.ssoServiceProviderId) && !(message.ssoServiceProviderId && $util.isInteger(message.ssoServiceProviderId.low) && $util.isInteger(message.ssoServiceProviderId.high)))
                    return "ssoServiceProviderId: integer|Long expected";
            if (message.ssoNodeId != null && Object.hasOwnProperty.call(message, "ssoNodeId"))
                if (!$util.isInteger(message.ssoNodeId) && !(message.ssoNodeId && $util.isInteger(message.ssoNodeId.low) && $util.isInteger(message.ssoNodeId.high)))
                    return "ssoNodeId: integer|Long expected";
            return null;
        };
    ...
    SsoCloud.SsoCloudConfigurationResponse = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SsoCloudConfigurationResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.lastModified != null && Object.hasOwnProperty.call(message, "lastModified"))
                if (!$util.isString(message.lastModified))
                    return "lastModified: string expected";
            if (message.ssoCloudSettingValue != null && Object.hasOwnProperty.call(message, "ssoCloudSettingValue")) {
                if (!Array.isArray(message.ssoCloudSettingValue))
                    return "ssoCloudSettingValue: array expected";
                for (let i = 0; i < message.ssoCloudSettingValue.length; ++i) {
                    let error = $root.SsoCloud.SsoCloudSettingValue.verify(message.ssoCloudSettingValue[i], long + 1);
                    if (error)
            ...
            if (message.sharedConfigs != null && Object.hasOwnProperty.call(message, "sharedConfigs")) {
                if (!Array.isArray(message.sharedConfigs))
                    return "sharedConfigs: array expected";
                for (let i = 0; i < message.sharedConfigs.length; ++i) {
                    let error = $root.SsoCloud.SsoSharedConfigItem.verify(message.sharedConfigs[i], long + 1);
                    if (error)
                        return "sharedConfigs." + error;
                }
            }
            return null;
        };
    ...
    SsoCloud.SsoCloudSAMLLogResponse = (function() {
        ...
        SsoCloudSAMLLogResponse.verify = function verify(message, long) {
            ...
            if (message.entry != null && Object.hasOwnProperty.call(message, "entry")) {
                ...
                for (let i = 0; i < message.entry.length; ++i) {
                    let error = $root.SsoCloud.SsoCloudSAMLLogEntry.verify(message.entry[i], long + 1);
                    if (error)
                        return "entry." + error;
                }
            }
    ...
    SsoCloud.SsoCloudServiceProviderUpdateRequest = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SsoCloudServiceProviderUpdateRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    SsoCloud.SsoCloudIdpMetadataRequest = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SsoCloudIdpMetadataRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    SsoCloud.SsoCloudIdpMetadataSupportRequest = (function() {
        ...
        /**
         * Encodes the specified SsoCloudIdpMetadataSupportRequest message, length delimited. Does not implicitly {@link SsoCloud.SsoCloudIdpMetadataSupportRequest.verify|verify} messages.
         * @function encodeDelimited
         * @memberof SsoCloud.SsoCloudIdpMetadataSupportRequest
         * @static
         * @param {SsoCloud.ISsoCloudIdpMetadataSupportRequest} message SsoCloudIdpMetadataSupportRequest message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SsoCloudIdpMetadataSupportRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
        ...
        /**
         * Decodes a SsoCloudIdpMetadataSupportRequest message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof SsoCloud.SsoCloudIdpMetadataSupportRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SsoCloudIdpMetadataSupportRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SsoCloudIdpMetadataSupportRequest message.
         * @function verify
         * @memberof SsoCloud.SsoCloudIdpMetadataSupportRequest
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        SsoCloudIdpMetadataSupportRequest.verify = function verify(message, long) {
            ...
            if (message.ssoSpConfigurationId != null && Object.hasOwnProperty.call(message, "ssoSpConfigurationId"))
                if (!$util.isInteger(message.ssoSpConfigurationId) && !(message.ssoSpConfigurationId && $util.isInteger(message.ssoSpConfigurationId.low) && $util.isInteger(message.ssoSpConfigurationId.high)))
                    return "ssoSpConfigurationId: integer|Long expected";
            if (message.ssoEnterpriseId != null && Object.hasOwnProperty.call(message, "ssoEnterpriseId"))
                if (!$util.isInteger(message.ssoEnterpriseId) && !(message.ssoEnterpriseId && $util.isInteger(message.ssoEnterpriseId.low) && $util.isInteger(message.ssoEnterpriseId.high)))
                    return "ssoEnterpriseId: integer|Long expected";
            if (message.filename != null && Object.hasOwnProperty.call(message, "filename"))
                if (!$util.isString(message.filename))
                    return "filename: string expected";
            if (message.content != null && Object.hasOwnProperty.call(message, "content"))
    ...
    SsoCloud.ValidationContent = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ValidationContent.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    SsoCloud.SsoCloudConfigurationValidationResponse = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SsoCloudConfigurationValidationResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.validationContent != null && Object.hasOwnProperty.call(message, "validationContent")) {
                if (!Array.isArray(message.validationContent))
                    return "validationContent: array expected";
                for (let i = 0; i < message.validationContent.length; ++i) {
                    let error = $root.SsoCloud.ValidationContent.verify(message.validationContent[i], long + 1);
                    if (error)
    ...
    SsoCloud.ConfigurationListItem = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ConfigurationListItem.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.ssoServiceProviderId != null && Object.hasOwnProperty.call(message, "ssoServiceProviderId")) {
                if (!Array.isArray(message.ssoServiceProviderId))
                    return "ssoServiceProviderId: array expected";
                for (let i = 0; i < message.ssoServiceProviderId.length; ++i)
                    if (!$util.isInteger(message.ssoServiceProviderId[i]) && !(message.ssoServiceProviderId[i] && $util.isInteger(message.ssoServiceProviderId[i].low) && $util.isInteger(message.ssoServiceProviderId[i].high)))
                        return "ssoServiceProviderId: integer|Long[] expected";
            }
            return null;
        };
    ...
    SsoCloud.SsoCloudServiceProviderConfigurationListResponse = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SsoCloudServiceProviderConfigurationListResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.configurationItem != null && Object.hasOwnProperty.call(message, "configurationItem")) {
                ...
                for (let i = 0; i < message.configurationItem.length; ++i) {
                    let error = $root.SsoCloud.ConfigurationListItem.verify(message.configurationItem[i], long + 1);
                    if (error)
    ...
    SsoCloud.SsoCloudMigrationStatusRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SsoCloudMigrationStatusRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SsoCloudMigrationStatusRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        SsoCloudMigrationStatusRequest.verify = function verify(message, long) {
            ...
            if (message.fullStatus != null && Object.hasOwnProperty.call(message, "fullStatus"))
                if (typeof message.fullStatus !== "boolean")
                    return "fullStatus: boolean expected";
            if (message.includeMigratedUsers != null && Object.hasOwnProperty.call(message, "includeMigratedUsers"))
                if (typeof message.includeMigratedUsers !== "boolean")
                    return "includeMigratedUsers: boolean expected";
            if (message.limit != null && Object.hasOwnProperty.call(message, "limit"))
    ...
    SsoCloud.SsoCloudMigrationStatusResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SsoCloudMigrationStatusResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SsoCloudMigrationStatusResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        SsoCloudMigrationStatusResponse.verify = function verify(message, long) {
            ...
            if (message.nodeId != null && Object.hasOwnProperty.call(message, "nodeId"))
                if (!$util.isInteger(message.nodeId) && !(message.nodeId && $util.isInteger(message.nodeId.low) && $util.isInteger(message.nodeId.high)))
                    return "nodeId: integer|Long expected";
            if (message.ssoConnectId != null && Object.hasOwnProperty.call(message, "ssoConnectId"))
                if (!$util.isInteger(message.ssoConnectId) && !(message.ssoConnectId && $util.isInteger(message.ssoConnectId.low) && $util.isInteger(message.ssoConnectId.high)))
                    return "ssoConnectId: integer|Long expected";
            if (message.ssoConnectName != null && Object.hasOwnProperty.call(message, "ssoConnectName"))
                if (!$util.isString(message.ssoConnectName))
                    return "ssoConnectName: string expected";
            if (message.ssoConnectCloudId != null && Object.hasOwnProperty.call(message, "ssoConnectCloudId"))
                if (!$util.isInteger(message.ssoConnectCloudId) && !(message.ssoConnectCloudId && $util.isInteger(message.ssoConnectCloudId.low) && $util.isInteger(message.ssoConnectCloudId.high)))
                    return "ssoConnectCloudId: integer|Long expected";
            if (message.ssoConnectCloudName != null && Object.hasOwnProperty.call(message, "ssoConnectCloudName"))
                if (!$util.isString(message.ssoConnectCloudName))
                    return "ssoConnectCloudName: string expected";
            if (message.totalUsersCount != null && Object.hasOwnProperty.call(message, "totalUsersCount"))
                if (!$util.isInteger(message.totalUsersCount))
                    return "totalUsersCount: integer expected";
            if (message.usersMigratedCount != null && Object.hasOwnProperty.call(message, "usersMigratedCount"))
                if (!$util.isInteger(message.usersMigratedCount))
                    return "usersMigratedCount: integer expected";
            if (message.migratedUsers != null && Object.hasOwnProperty.call(message, "migratedUsers")) {
                if (!Array.isArray(message.migratedUsers))
                    return "migratedUsers: array expected";
                for (let i = 0; i < message.migratedUsers.length; ++i) {
                    let error = $root.SsoCloud.SsoCloudMigrationUserInfo.verify(message.migratedUsers[i], long + 1);
                    if (error)
                        return "migratedUsers." + error;
                }
            }
            if (message.unmigratedUsers != null && Object.hasOwnProperty.call(message, "unmigratedUsers")) {
                if (!Array.isArray(message.unmigratedUsers))
                    return "unmigratedUsers: array expected";
                for (let i = 0; i < message.unmigratedUsers.length; ++i) {
                    let error = $root.SsoCloud.SsoCloudMigrationUserInfo.verify(message.unmigratedUsers[i], long + 1);
                    if (error)
                        return "unmigratedUsers." + error;
                }
            }
            return null;
        };
    ...
    SsoCloud.SsoCloudMigrationUserInfo = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SsoCloudMigrationUserInfo.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SsoCloudMigrationUserInfo.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        SsoCloudMigrationUserInfo.verify = function verify(message, long) {
            ...
            if (message.isMigrated != null && Object.hasOwnProperty.call(message, "isMigrated"))
                if (typeof message.isMigrated !== "boolean")
                    return "isMigrated: boolean expected";
            return null;
        };
