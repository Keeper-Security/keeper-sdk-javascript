...
export const GraphSync = $root.GraphSync = (() => {
    ...
    GraphSync.GraphSyncRef = (function() {
         ...
         */
        GraphSyncRef.verify = function verify(message, long) {
    ...
    GraphSync.GraphSyncActor = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncActor.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.name != null && Object.hasOwnProperty.call(message, "name"))
                if (!$util.isString(message.name))
                    return "name: string expected";
            if (message.effectiveUserId != null && Object.hasOwnProperty.call(message, "effectiveUserId"))
                if (!(message.effectiveUserId && typeof message.effectiveUserId.length === "number" || $util.isString(message.effectiveUserId)))
    ...
    GraphSync.GraphSyncData = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncData.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.ref != null && Object.hasOwnProperty.call(message, "ref")) {
                let error = $root.GraphSync.GraphSyncRef.verify(message.ref, long + 1);
                if (error)
                    return "ref." + error;
            }
            if (message.parentRef != null && Object.hasOwnProperty.call(message, "parentRef")) {
                let error = $root.GraphSync.GraphSyncRef.verify(message.parentRef, long + 1);
                if (error)
    ...
    GraphSync.GraphSyncDataPlus = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncDataPlus.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.data != null && Object.hasOwnProperty.call(message, "data")) {
                let error = $root.GraphSync.GraphSyncData.verify(message.data, long + 1);
                if (error)
                    return "data." + error;
            }
            if (message.timestamp != null && Object.hasOwnProperty.call(message, "timestamp"))
            ...
            if (message.actor != null && Object.hasOwnProperty.call(message, "actor")) {
                let error = $root.GraphSync.GraphSyncActor.verify(message.actor, long + 1);
                if (error)
                    return "actor." + error;
            }
            return null;
    ...
    GraphSync.GraphSyncQuery = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncQuery.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.streamId != null && Object.hasOwnProperty.call(message, "streamId"))
                if (!(message.streamId && typeof message.streamId.length === "number" || $util.isString(message.streamId)))
    ...
    GraphSync.GraphSyncResult = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncResult.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.data != null && Object.hasOwnProperty.call(message, "data")) {
                ...
                for (let i = 0; i < message.data.length; ++i) {
                    let error = $root.GraphSync.GraphSyncDataPlus.verify(message.data[i], long + 1);
                    if (error)
                        return "data." + error;
                }
            }
    ...
    GraphSync.GraphSyncMultiQuery = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncMultiQuery.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.queries != null && Object.hasOwnProperty.call(message, "queries")) {
                ...
                for (let i = 0; i < message.queries.length; ++i) {
                    let error = $root.GraphSync.GraphSyncQuery.verify(message.queries[i], long + 1);
                    if (error)
    ...
    GraphSync.GraphSyncMultiResult = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncMultiResult.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.results != null && Object.hasOwnProperty.call(message, "results")) {
                ...
                for (let i = 0; i < message.results.length; ++i) {
                    let error = $root.GraphSync.GraphSyncResult.verify(message.results[i], long + 1);
                    if (error)
    ...
    GraphSync.GraphSyncAddDataRequest = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncAddDataRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.origin != null && Object.hasOwnProperty.call(message, "origin")) {
                let error = $root.GraphSync.GraphSyncRef.verify(message.origin, long + 1);
                if (error)
                    return "origin." + error;
            }
            if (message.data != null && Object.hasOwnProperty.call(message, "data")) {
                if (!Array.isArray(message.data))
                    return "data: array expected";
                for (let i = 0; i < message.data.length; ++i) {
                    let error = $root.GraphSync.GraphSyncData.verify(message.data[i], long + 1);
                    if (error)
                        return "data." + error;
                }
            }
    ...
    GraphSync.GraphSyncLeafsQuery = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncLeafsQuery.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.vertices != null && Object.hasOwnProperty.call(message, "vertices")) {
                ...
                for (let i = 0; i < message.vertices.length; ++i)
                    if (!(message.vertices[i] && typeof message.vertices[i].length === "number" || $util.isString(message.vertices[i])))
    ...
    GraphSync.GraphSyncRefsResult = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GraphSyncRefsResult.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
