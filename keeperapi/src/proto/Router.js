...
export const Router = $root.Router = (() => {
    ...
    Router.RouterUserAuth = (function() {
         ...
         * @property {number|null} [deviceId] RouterUserAuth deviceId
         */
        ...
        /**
         * RouterUserAuth deviceId.
         * @member {number|null|undefined} deviceId
         * @memberof Router.RouterUserAuth
         * @instance
         */
        RouterUserAuth.prototype.deviceId = null;

        // OneOf field names bound to virtual getters and setters
        let $oneOfFields;

        // Virtual OneOf for proto3 optional field
        Object.defineProperty(RouterUserAuth.prototype, "_deviceId", {
        ...
        RouterUserAuth.encode = function encode(message, writer, q) {
            ...
            if (message.deviceId != null && Object.hasOwnProperty.call(message, "deviceId"))
                writer.uint32(/* id 13, wireType 0 =*/104).int64(message.deviceId);
            return writer;
        };
    ...
    /**
     * UserAccessLoweredEventType enum.
     * @name Router.UserAccessLoweredEventType
     * @enum {number}
     * @property {number} UALE_UNSPECIFIED=0 UALE_UNSPECIFIED value
     * @property {number} UALE_DEVICE_LOGOUT=1 UALE_DEVICE_LOGOUT value
     * @property {number} UALE_USER_LOGOUT_ALL_DEVICES=2 UALE_USER_LOGOUT_ALL_DEVICES value
     * @property {number} UALE_ENFORCEMENT_REMOVED=3 UALE_ENFORCEMENT_REMOVED value
     * @property {number} UALE_RECORD_ACCESS_LOST=4 UALE_RECORD_ACCESS_LOST value
     */
    Router.UserAccessLoweredEventType = (function() {
        const valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "UALE_UNSPECIFIED"] = 0;
        values[valuesById[1] = "UALE_DEVICE_LOGOUT"] = 1;
        values[valuesById[2] = "UALE_USER_LOGOUT_ALL_DEVICES"] = 2;
        values[valuesById[3] = "UALE_ENFORCEMENT_REMOVED"] = 3;
        values[valuesById[4] = "UALE_RECORD_ACCESS_LOST"] = 4;
        return values;
    })();

    Router.UserAccessLoweredEvent = (function() {

        /**
         * Properties of a UserAccessLoweredEvent.
         * @memberof Router
         * @interface IUserAccessLoweredEvent
         * @property {Router.UserAccessLoweredEventType|null} [eventType] UserAccessLoweredEvent eventType
         * @property {Array.<number>|null} [enterpriseUserIds] UserAccessLoweredEvent enterpriseUserIds
         * @property {Array.<Uint8Array>|null} [recordUids] UserAccessLoweredEvent recordUids
         * @property {number|null} [deviceId] UserAccessLoweredEvent deviceId
         * @property {number|null} [enforcementTypeId] UserAccessLoweredEvent enforcementTypeId
         */

        /**
         * Constructs a new UserAccessLoweredEvent.
         * @memberof Router
         * @classdesc Represents a UserAccessLoweredEvent.
         * @implements IUserAccessLoweredEvent
         * @constructor
         * @param {Router.IUserAccessLoweredEvent=} [properties] Properties to set
         */
        function UserAccessLoweredEvent(properties) {
        ...
        /**
         * UserAccessLoweredEvent eventType.
         * @member {Router.UserAccessLoweredEventType} eventType
         * @memberof Router.UserAccessLoweredEvent
         * @instance
         */
        UserAccessLoweredEvent.prototype.eventType = 0;

        /**
         * UserAccessLoweredEvent enterpriseUserIds.
         * @member {Array.<number>} enterpriseUserIds
         * @memberof Router.UserAccessLoweredEvent
         * @instance
         */
        UserAccessLoweredEvent.prototype.enterpriseUserIds = $util.emptyArray;

        /**
         * UserAccessLoweredEvent recordUids.
         * @member {Array.<Uint8Array>} recordUids
         * @memberof Router.UserAccessLoweredEvent
         * @instance
         */
        UserAccessLoweredEvent.prototype.recordUids = $util.emptyArray;

        /**
         * UserAccessLoweredEvent deviceId.
         * @member {number|null|undefined} deviceId
         * @memberof Router.UserAccessLoweredEvent
         * @instance
         */
        UserAccessLoweredEvent.prototype.deviceId = null;

        /**
         * UserAccessLoweredEvent enforcementTypeId.
         * @member {number|null|undefined} enforcementTypeId
         * @memberof Router.UserAccessLoweredEvent
         * @instance
         */
        UserAccessLoweredEvent.prototype.enforcementTypeId = null;

        // OneOf field names bound to virtual getters and setters
        let $oneOfFields;

        // Virtual OneOf for proto3 optional field
        Object.defineProperty(UserAccessLoweredEvent.prototype, "_deviceId", {
            get: $util.oneOfGetter($oneOfFields = ["deviceId"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        // Virtual OneOf for proto3 optional field
        Object.defineProperty(UserAccessLoweredEvent.prototype, "_enforcementTypeId", {
            get: $util.oneOfGetter($oneOfFields = ["enforcementTypeId"]),
            set: $util.oneOfSetter($oneOfFields)
        });

        /**
         * Creates a new UserAccessLoweredEvent instance using the specified properties.
         * @function create
         * @memberof Router.UserAccessLoweredEvent
         * @static
         * @param {Router.IUserAccessLoweredEvent=} [properties] Properties to set
         * @returns {Router.UserAccessLoweredEvent} UserAccessLoweredEvent instance
         */
        UserAccessLoweredEvent.create = function create(properties) {
            return new UserAccessLoweredEvent(properties);
        };

        /**
         * Encodes the specified UserAccessLoweredEvent message. Does not implicitly {@link Router.UserAccessLoweredEvent.verify|verify} messages.
         * @function encode
         * @memberof Router.UserAccessLoweredEvent
         * @static
         * @param {Router.IUserAccessLoweredEvent} message UserAccessLoweredEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        UserAccessLoweredEvent.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.deviceId != null && Object.hasOwnProperty.call(message, "deviceId"))
                writer.uint32(/* id 4, wireType 0 =*/32).int64(message.deviceId);
            if (message.enforcementTypeId != null && Object.hasOwnProperty.call(message, "enforcementTypeId"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.enforcementTypeId);
            return writer;
        };

        /**
         * Decodes a UserAccessLoweredEvent message from the specified reader or buffer.
         * @function decode
         * @memberof Router.UserAccessLoweredEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {Router.UserAccessLoweredEvent} UserAccessLoweredEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserAccessLoweredEvent.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Router.UserAccessLoweredEvent();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        ...
                        if ((tag & 7) === 2) {
                            let end2 = reader.uint32() + reader.pos;
                            while (reader.pos < end2)
                                message.enterpriseUserIds.push(reader.int64());
                        } else
                            message.enterpriseUserIds.push(reader.int64());
                        break;
                    }
        ...
        /**
         * Creates a UserAccessLoweredEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof Router.UserAccessLoweredEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {Router.UserAccessLoweredEvent} UserAccessLoweredEvent
         */
        UserAccessLoweredEvent.fromObject = function fromObject(object, long) {
            if (object instanceof $root.Router.UserAccessLoweredEvent)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".Router.UserAccessLoweredEvent: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.Router.UserAccessLoweredEvent();
            ...
            default:
                ...
                break;
            case "UALE_UNSPECIFIED":
            case 0:
                message.eventType = 0;
                break;
            case "UALE_DEVICE_LOGOUT":
            case 1:
                message.eventType = 1;
                break;
            case "UALE_USER_LOGOUT_ALL_DEVICES":
            case 2:
                message.eventType = 2;
                break;
            case "UALE_ENFORCEMENT_REMOVED":
            case 3:
                message.eventType = 3;
                break;
            case "UALE_RECORD_ACCESS_LOST":
            case 4:
                message.eventType = 4;
                break;
            }
            if (object.enterpriseUserIds) {
                if (!Array.isArray(object.enterpriseUserIds))
                    throw TypeError(".Router.UserAccessLoweredEvent.enterpriseUserIds: array expected");
                message.enterpriseUserIds = [];
                for (let i = 0; i < object.enterpriseUserIds.length; ++i)
                    if ($util.Long)
                        message.enterpriseUserIds[i] = $util.Long.fromValue(object.enterpriseUserIds[i], false);
                        ...
                        message.enterpriseUserIds[i] = new $util.LongBits(object.enterpriseUserIds[i].low >>> 0, object.enterpriseUserIds[i].high >>> 0).toNumber();
            }
            if (object.recordUids) {
                if (!Array.isArray(object.recordUids))
                    throw TypeError(".Router.UserAccessLoweredEvent.recordUids: array expected");
                message.recordUids = [];
        ...
        /**
         * Creates a plain object from a UserAccessLoweredEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof Router.UserAccessLoweredEvent
         * @static
         * @param {Router.UserAccessLoweredEvent} message UserAccessLoweredEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        UserAccessLoweredEvent.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
            ...
            if (options.defaults)
                object.eventType = options.enums === String ? "UALE_UNSPECIFIED" : 0;
            if (message.eventType != null && Object.hasOwnProperty.call(message, "eventType"))
                object.eventType = options.enums === String ? $root.Router.UserAccessLoweredEventType[message.eventType] === undefined ? message.eventType : $root.Router.UserAccessLoweredEventType[message.eventType] : message.eventType;
            if (message.enterpriseUserIds && message.enterpriseUserIds.length) {
                object.enterpriseUserIds = [];
                for (let j = 0; j < message.enterpriseUserIds.length; ++j)
                    if (typeof BigInt !== "undefined" && options.longs === BigInt)
                        object.enterpriseUserIds[j] = typeof message.enterpriseUserIds[j] === "number" ? BigInt(message.enterpriseUserIds[j]) : $util.Long.fromBits(message.enterpriseUserIds[j].low >>> 0, message.enterpriseUserIds[j].high >>> 0, false).toBigInt();
                    else if (typeof message.enterpriseUserIds[j] === "number")
                        object.enterpriseUserIds[j] = options.longs === String ? String(message.enterpriseUserIds[j]) : message.enterpriseUserIds[j];
                    else
                        object.enterpriseUserIds[j] = options.longs === String ? $util.Long.prototype.toString.call(message.enterpriseUserIds[j]) : options.longs === Number ? new $util.LongBits(message.enterpriseUserIds[j].low >>> 0, message.enterpriseUserIds[j].high >>> 0).toNumber() : message.enterpriseUserIds[j];
            }
            if (message.recordUids && message.recordUids.length) {
                object.recordUids = [];
            ...
            if (message.enforcementTypeId != null && Object.hasOwnProperty.call(message, "enforcementTypeId")) {
                object.enforcementTypeId = message.enforcementTypeId;
                if (options.oneofs)
                    object._enforcementTypeId = "enforcementTypeId";
            }
            return object;
        };

        /**
         * Converts this UserAccessLoweredEvent to JSON.
         * @function toJSON
         * @memberof Router.UserAccessLoweredEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        UserAccessLoweredEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for UserAccessLoweredEvent
         * @function getTypeUrl
         * @memberof Router.UserAccessLoweredEvent
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        UserAccessLoweredEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/Router.UserAccessLoweredEvent";
        };

        return UserAccessLoweredEvent;
    })();

    Router.UserAccessLoweredEventsRequest = (function() {

        /**
         * Properties of a UserAccessLoweredEventsRequest.
         * @memberof Router
         * @interface IUserAccessLoweredEventsRequest
         * @property {Array.<Router.IUserAccessLoweredEvent>|null} [events] UserAccessLoweredEventsRequest events
         */

        /**
         * Constructs a new UserAccessLoweredEventsRequest.
         * @memberof Router
         * @classdesc Represents a UserAccessLoweredEventsRequest.
         * @implements IUserAccessLoweredEventsRequest
         * @constructor
         * @param {Router.IUserAccessLoweredEventsRequest=} [properties] Properties to set
         */
        function UserAccessLoweredEventsRequest(properties) {
            this.events = [];
            if (properties)
                for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null && keys[i] !== "__proto__")
        ...
        /**
         * UserAccessLoweredEventsRequest events.
         * @member {Array.<Router.IUserAccessLoweredEvent>} events
         * @memberof Router.UserAccessLoweredEventsRequest
         * @instance
         */
        UserAccessLoweredEventsRequest.prototype.events = $util.emptyArray;

        /**
         * Creates a new UserAccessLoweredEventsRequest instance using the specified properties.
         * @function create
         * @memberof Router.UserAccessLoweredEventsRequest
         * @static
         * @param {Router.IUserAccessLoweredEventsRequest=} [properties] Properties to set
         * @returns {Router.UserAccessLoweredEventsRequest} UserAccessLoweredEventsRequest instance
         */
        UserAccessLoweredEventsRequest.create = function create(properties) {
            return new UserAccessLoweredEventsRequest(properties);
        };

        /**
         * Encodes the specified UserAccessLoweredEventsRequest message. Does not implicitly {@link Router.UserAccessLoweredEventsRequest.verify|verify} messages.
         * @function encode
         * @memberof Router.UserAccessLoweredEventsRequest
         * @static
         * @param {Router.IUserAccessLoweredEventsRequest} message UserAccessLoweredEventsRequest message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        UserAccessLoweredEventsRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
            ...
            if (message.events != null && message.events.length)
                for (let i = 0; i < message.events.length; ++i)
                    $root.Router.UserAccessLoweredEvent.encode(message.events[i], writer.uint32(/* id 1, wireType 2 =*/10).fork(), q + 1).ldelim();
            return writer;
        };

        /**
         * Decodes a UserAccessLoweredEventsRequest message from the specified reader or buffer.
         * @function decode
         * @memberof Router.UserAccessLoweredEventsRequest
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {Router.UserAccessLoweredEventsRequest} UserAccessLoweredEventsRequest
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserAccessLoweredEventsRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Router.UserAccessLoweredEventsRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 1: {
                        if (!(message.events && message.events.length))
                            message.events = [];
                        message.events.push($root.Router.UserAccessLoweredEvent.decode(reader, reader.uint32(), undefined, long + 1));
                        break;
                    }
                default:
                    reader.skipType(tag & 7, long);
        ...
        /**
         * Creates a UserAccessLoweredEventsRequest message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof Router.UserAccessLoweredEventsRequest
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {Router.UserAccessLoweredEventsRequest} UserAccessLoweredEventsRequest
         */
        UserAccessLoweredEventsRequest.fromObject = function fromObject(object, long) {
            if (object instanceof $root.Router.UserAccessLoweredEventsRequest)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".Router.UserAccessLoweredEventsRequest: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.Router.UserAccessLoweredEventsRequest();
            if (object.events) {
                if (!Array.isArray(object.events))
                    throw TypeError(".Router.UserAccessLoweredEventsRequest.events: array expected");
                message.events = [];
                for (let i = 0; i < object.events.length; ++i) {
                    if (!$util.isObject(object.events[i]))
                        throw TypeError(".Router.UserAccessLoweredEventsRequest.events: object expected");
                    message.events[i] = $root.Router.UserAccessLoweredEvent.fromObject(object.events[i], long + 1);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a UserAccessLoweredEventsRequest message. Also converts values to other types if specified.
         * @function toObject
         * @memberof Router.UserAccessLoweredEventsRequest
         * @static
         * @param {Router.UserAccessLoweredEventsRequest} message UserAccessLoweredEventsRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        UserAccessLoweredEventsRequest.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
            ...
            if (message.events && message.events.length) {
                ...
                for (let j = 0; j < message.events.length; ++j)
                    object.events[j] = $root.Router.UserAccessLoweredEvent.toObject(message.events[j], options, q + 1);
            }
            return object;
        };

        /**
         * Converts this UserAccessLoweredEventsRequest to JSON.
         * @function toJSON
         * @memberof Router.UserAccessLoweredEventsRequest
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        UserAccessLoweredEventsRequest.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for UserAccessLoweredEventsRequest
         * @function getTypeUrl
         * @memberof Router.UserAccessLoweredEventsRequest
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        UserAccessLoweredEventsRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/Router.UserAccessLoweredEventsRequest";
        };
