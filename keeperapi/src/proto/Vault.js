...
export const Vault = $root.Vault = (() => {
    ...
    Vault.SyncDownRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SyncDownRequest.encodeDelimited = function encodeDelimited(message, writer) {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SyncDownRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
         ...
         */
        SyncDownRequest.verify = function verify(message, long) {
            ...
            if (message.continuationToken != null && Object.hasOwnProperty.call(message, "continuationToken"))
                if (!(message.continuationToken && typeof message.continuationToken.length === "number" || $util.isString(message.continuationToken)))
    ...
    Vault.SyncDownResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SyncDownResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SyncDownResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SyncDownResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.userFolders != null && Object.hasOwnProperty.call(message, "userFolders")) {
                if (!Array.isArray(message.userFolders))
                    return "userFolders: array expected";
                for (let i = 0; i < message.userFolders.length; ++i) {
                    let error = $root.Vault.UserFolder.verify(message.userFolders[i], long + 1);
                    if (error)
                        return "userFolders." + error;
                }
            }
            if (message.sharedFolders != null && Object.hasOwnProperty.call(message, "sharedFolders")) {
                if (!Array.isArray(message.sharedFolders))
                    return "sharedFolders: array expected";
                for (let i = 0; i < message.sharedFolders.length; ++i) {
                    let error = $root.Vault.SharedFolder.verify(message.sharedFolders[i], long + 1);
                    if (error)
                        return "sharedFolders." + error;
                }
            }
            if (message.userFolderSharedFolders != null && Object.hasOwnProperty.call(message, "userFolderSharedFolders")) {
                if (!Array.isArray(message.userFolderSharedFolders))
                    return "userFolderSharedFolders: array expected";
                for (let i = 0; i < message.userFolderSharedFolders.length; ++i) {
                    let error = $root.Vault.UserFolderSharedFolder.verify(message.userFolderSharedFolders[i], long + 1);
                    if (error)
                        return "userFolderSharedFolders." + error;
                }
            }
            if (message.sharedFolderFolders != null && Object.hasOwnProperty.call(message, "sharedFolderFolders")) {
                if (!Array.isArray(message.sharedFolderFolders))
                    return "sharedFolderFolders: array expected";
                for (let i = 0; i < message.sharedFolderFolders.length; ++i) {
                    let error = $root.Vault.SharedFolderFolder.verify(message.sharedFolderFolders[i], long + 1);
                    if (error)
                        return "sharedFolderFolders." + error;
                }
            }
            if (message.records != null && Object.hasOwnProperty.call(message, "records")) {
                ...
                for (let i = 0; i < message.records.length; ++i) {
                    let error = $root.Vault.Record.verify(message.records[i], long + 1);
                    if (error)
                        return "records." + error;
                }
            }
            if (message.recordMetaData != null && Object.hasOwnProperty.call(message, "recordMetaData")) {
                if (!Array.isArray(message.recordMetaData))
                    return "recordMetaData: array expected";
                for (let i = 0; i < message.recordMetaData.length; ++i) {
                    let error = $root.Vault.RecordMetaData.verify(message.recordMetaData[i], long + 1);
                    if (error)
                        return "recordMetaData." + error;
                }
            }
            if (message.nonSharedData != null && Object.hasOwnProperty.call(message, "nonSharedData")) {
                if (!Array.isArray(message.nonSharedData))
                    return "nonSharedData: array expected";
                for (let i = 0; i < message.nonSharedData.length; ++i) {
                    let error = $root.Vault.NonSharedData.verify(message.nonSharedData[i], long + 1);
                    if (error)
                        return "nonSharedData." + error;
                }
            }
            if (message.recordLinks != null && Object.hasOwnProperty.call(message, "recordLinks")) {
                ...
                for (let i = 0; i < message.recordLinks.length; ++i) {
                    let error = $root.Vault.RecordLink.verify(message.recordLinks[i], long + 1);
                    if (error)
                        return "recordLinks." + error;
                }
            }
            if (message.userFolderRecords != null && Object.hasOwnProperty.call(message, "userFolderRecords")) {
                if (!Array.isArray(message.userFolderRecords))
                    return "userFolderRecords: array expected";
                for (let i = 0; i < message.userFolderRecords.length; ++i) {
                    let error = $root.Vault.UserFolderRecord.verify(message.userFolderRecords[i], long + 1);
                    if (error)
                        return "userFolderRecords." + error;
                }
            }
            if (message.sharedFolderRecords != null && Object.hasOwnProperty.call(message, "sharedFolderRecords")) {
                if (!Array.isArray(message.sharedFolderRecords))
                    return "sharedFolderRecords: array expected";
                for (let i = 0; i < message.sharedFolderRecords.length; ++i) {
                    let error = $root.Vault.SharedFolderRecord.verify(message.sharedFolderRecords[i], long + 1);
                    if (error)
                        return "sharedFolderRecords." + error;
                }
            }
            if (message.sharedFolderFolderRecords != null && Object.hasOwnProperty.call(message, "sharedFolderFolderRecords")) {
                if (!Array.isArray(message.sharedFolderFolderRecords))
                    return "sharedFolderFolderRecords: array expected";
                for (let i = 0; i < message.sharedFolderFolderRecords.length; ++i) {
                    let error = $root.Vault.SharedFolderFolderRecord.verify(message.sharedFolderFolderRecords[i], long + 1);
                    if (error)
                        return "sharedFolderFolderRecords." + error;
                }
            }
            if (message.sharedFolderUsers != null && Object.hasOwnProperty.call(message, "sharedFolderUsers")) {
                if (!Array.isArray(message.sharedFolderUsers))
                    return "sharedFolderUsers: array expected";
                for (let i = 0; i < message.sharedFolderUsers.length; ++i) {
                    let error = $root.Vault.SharedFolderUser.verify(message.sharedFolderUsers[i], long + 1);
                    if (error)
                        return "sharedFolderUsers." + error;
                }
            }
            if (message.sharedFolderTeams != null && Object.hasOwnProperty.call(message, "sharedFolderTeams")) {
                if (!Array.isArray(message.sharedFolderTeams))
                    return "sharedFolderTeams: array expected";
                for (let i = 0; i < message.sharedFolderTeams.length; ++i) {
                    let error = $root.Vault.SharedFolderTeam.verify(message.sharedFolderTeams[i], long + 1);
                    if (error)
                        return "sharedFolderTeams." + error;
                }
            }
            if (message.recordAddAuditData != null && Object.hasOwnProperty.call(message, "recordAddAuditData")) {
                if (!Array.isArray(message.recordAddAuditData))
                    return "recordAddAuditData: array expected";
                for (let i = 0; i < message.recordAddAuditData.length; ++i)
                    if (!(message.recordAddAuditData[i] && typeof message.recordAddAuditData[i].length === "number" || $util.isString(message.recordAddAuditData[i])))
                        return "recordAddAuditData: buffer[] expected";
            }
            if (message.teams != null && Object.hasOwnProperty.call(message, "teams")) {
                if (!Array.isArray(message.teams))
                    return "teams: array expected";
                for (let i = 0; i < message.teams.length; ++i) {
                    let error = $root.Vault.Team.verify(message.teams[i], long + 1);
                    if (error)
                        return "teams." + error;
                }
            }
            if (message.sharingChanges != null && Object.hasOwnProperty.call(message, "sharingChanges")) {
                if (!Array.isArray(message.sharingChanges))
                    return "sharingChanges: array expected";
                for (let i = 0; i < message.sharingChanges.length; ++i) {
                    let error = $root.Vault.SharingChange.verify(message.sharingChanges[i], long + 1);
                    if (error)
                        return "sharingChanges." + error;
                }
            }
            if (message.profile != null && Object.hasOwnProperty.call(message, "profile")) {
                let error = $root.Vault.Profile.verify(message.profile, long + 1);
                if (error)
                    return "profile." + error;
            }
            if (message.profilePic != null && Object.hasOwnProperty.call(message, "profilePic")) {
                let error = $root.Vault.ProfilePic.verify(message.profilePic, long + 1);
                if (error)
                    return "profilePic." + error;
            }
            if (message.pendingTeamMembers != null && Object.hasOwnProperty.call(message, "pendingTeamMembers")) {
                if (!Array.isArray(message.pendingTeamMembers))
                    return "pendingTeamMembers: array expected";
                for (let i = 0; i < message.pendingTeamMembers.length; ++i) {
                    let error = $root.Vault.PendingTeamMember.verify(message.pendingTeamMembers[i], long + 1);
                    if (error)
                        return "pendingTeamMembers." + error;
                }
            }
            if (message.breachWatchRecords != null && Object.hasOwnProperty.call(message, "breachWatchRecords")) {
                if (!Array.isArray(message.breachWatchRecords))
                    return "breachWatchRecords: array expected";
                for (let i = 0; i < message.breachWatchRecords.length; ++i) {
                    let error = $root.Vault.BreachWatchRecord.verify(message.breachWatchRecords[i], long + 1);
                    if (error)
                        return "breachWatchRecords." + error;
                }
            }
            if (message.userAuths != null && Object.hasOwnProperty.call(message, "userAuths")) {
                if (!Array.isArray(message.userAuths))
                    return "userAuths: array expected";
                for (let i = 0; i < message.userAuths.length; ++i) {
                    let error = $root.Vault.UserAuth.verify(message.userAuths[i], long + 1);
                    if (error)
                        return "userAuths." + error;
                }
            }
            if (message.breachWatchSecurityData != null && Object.hasOwnProperty.call(message, "breachWatchSecurityData")) {
                if (!Array.isArray(message.breachWatchSecurityData))
                    return "breachWatchSecurityData: array expected";
                for (let i = 0; i < message.breachWatchSecurityData.length; ++i) {
                    let error = $root.Vault.BreachWatchSecurityData.verify(message.breachWatchSecurityData[i], long + 1);
                    if (error)
                        return "breachWatchSecurityData." + error;
                }
            }
            if (message.reusedPasswords != null && Object.hasOwnProperty.call(message, "reusedPasswords")) {
                let error = $root.Vault.ReusedPasswords.verify(message.reusedPasswords, long + 1);
                if (error)
                    return "reusedPasswords." + error;
            }
            if (message.removedUserFolders != null && Object.hasOwnProperty.call(message, "removedUserFolders")) {
                if (!Array.isArray(message.removedUserFolders))
                    return "removedUserFolders: array expected";
                for (let i = 0; i < message.removedUserFolders.length; ++i)
                    if (!(message.removedUserFolders[i] && typeof message.removedUserFolders[i].length === "number" || $util.isString(message.removedUserFolders[i])))
                        return "removedUserFolders: buffer[] expected";
            }
            if (message.removedSharedFolders != null && Object.hasOwnProperty.call(message, "removedSharedFolders")) {
                if (!Array.isArray(message.removedSharedFolders))
                    return "removedSharedFolders: array expected";
                for (let i = 0; i < message.removedSharedFolders.length; ++i)
                    if (!(message.removedSharedFolders[i] && typeof message.removedSharedFolders[i].length === "number" || $util.isString(message.removedSharedFolders[i])))
                        return "removedSharedFolders: buffer[] expected";
            }
            if (message.removedUserFolderSharedFolders != null && Object.hasOwnProperty.call(message, "removedUserFolderSharedFolders")) {
                if (!Array.isArray(message.removedUserFolderSharedFolders))
                    return "removedUserFolderSharedFolders: array expected";
                for (let i = 0; i < message.removedUserFolderSharedFolders.length; ++i) {
                    let error = $root.Vault.UserFolderSharedFolder.verify(message.removedUserFolderSharedFolders[i], long + 1);
                    if (error)
                        return "removedUserFolderSharedFolders." + error;
                }
            }
            if (message.removedSharedFolderFolders != null && Object.hasOwnProperty.call(message, "removedSharedFolderFolders")) {
                if (!Array.isArray(message.removedSharedFolderFolders))
                    return "removedSharedFolderFolders: array expected";
                for (let i = 0; i < message.removedSharedFolderFolders.length; ++i) {
                    let error = $root.Vault.SharedFolderFolder.verify(message.removedSharedFolderFolders[i], long + 1);
                    if (error)
                        return "removedSharedFolderFolders." + error;
                }
            }
            if (message.removedRecords != null && Object.hasOwnProperty.call(message, "removedRecords")) {
                if (!Array.isArray(message.removedRecords))
                    return "removedRecords: array expected";
                for (let i = 0; i < message.removedRecords.length; ++i)
                    if (!(message.removedRecords[i] && typeof message.removedRecords[i].length === "number" || $util.isString(message.removedRecords[i])))
                        return "removedRecords: buffer[] expected";
            }
            if (message.removedRecordLinks != null && Object.hasOwnProperty.call(message, "removedRecordLinks")) {
                if (!Array.isArray(message.removedRecordLinks))
                    return "removedRecordLinks: array expected";
                for (let i = 0; i < message.removedRecordLinks.length; ++i) {
                    let error = $root.Vault.RecordLink.verify(message.removedRecordLinks[i], long + 1);
                    if (error)
                        return "removedRecordLinks." + error;
                }
            }
            if (message.removedUserFolderRecords != null && Object.hasOwnProperty.call(message, "removedUserFolderRecords")) {
                if (!Array.isArray(message.removedUserFolderRecords))
                    return "removedUserFolderRecords: array expected";
                for (let i = 0; i < message.removedUserFolderRecords.length; ++i) {
                    let error = $root.Vault.UserFolderRecord.verify(message.removedUserFolderRecords[i], long + 1);
                    if (error)
                        return "removedUserFolderRecords." + error;
                }
            }
            if (message.removedSharedFolderRecords != null && Object.hasOwnProperty.call(message, "removedSharedFolderRecords")) {
                if (!Array.isArray(message.removedSharedFolderRecords))
                    return "removedSharedFolderRecords: array expected";
                for (let i = 0; i < message.removedSharedFolderRecords.length; ++i) {
                    let error = $root.Vault.SharedFolderRecord.verify(message.removedSharedFolderRecords[i], long + 1);
                    if (error)
                        return "removedSharedFolderRecords." + error;
                }
            }
            if (message.removedSharedFolderFolderRecords != null && Object.hasOwnProperty.call(message, "removedSharedFolderFolderRecords")) {
                if (!Array.isArray(message.removedSharedFolderFolderRecords))
                    return "removedSharedFolderFolderRecords: array expected";
                for (let i = 0; i < message.removedSharedFolderFolderRecords.length; ++i) {
                    let error = $root.Vault.SharedFolderFolderRecord.verify(message.removedSharedFolderFolderRecords[i], long + 1);
                    if (error)
                        return "removedSharedFolderFolderRecords." + error;
                }
            }
            if (message.removedSharedFolderUsers != null && Object.hasOwnProperty.call(message, "removedSharedFolderUsers")) {
                if (!Array.isArray(message.removedSharedFolderUsers))
                    return "removedSharedFolderUsers: array expected";
                for (let i = 0; i < message.removedSharedFolderUsers.length; ++i) {
                    let error = $root.Vault.SharedFolderUser.verify(message.removedSharedFolderUsers[i], long + 1);
                    if (error)
                        return "removedSharedFolderUsers." + error;
                }
            }
            if (message.removedSharedFolderTeams != null && Object.hasOwnProperty.call(message, "removedSharedFolderTeams")) {
                if (!Array.isArray(message.removedSharedFolderTeams))
                    return "removedSharedFolderTeams: array expected";
                for (let i = 0; i < message.removedSharedFolderTeams.length; ++i) {
                    let error = $root.Vault.SharedFolderTeam.verify(message.removedSharedFolderTeams[i], long + 1);
                    if (error)
                        return "removedSharedFolderTeams." + error;
                }
            }
            if (message.removedTeams != null && Object.hasOwnProperty.call(message, "removedTeams")) {
                if (!Array.isArray(message.removedTeams))
                    return "removedTeams: array expected";
                for (let i = 0; i < message.removedTeams.length; ++i)
                    if (!(message.removedTeams[i] && typeof message.removedTeams[i].length === "number" || $util.isString(message.removedTeams[i])))
                        return "removedTeams: buffer[] expected";
            }
            if (message.ksmAppShares != null && Object.hasOwnProperty.call(message, "ksmAppShares")) {
                if (!Array.isArray(message.ksmAppShares))
                    return "ksmAppShares: array expected";
                for (let i = 0; i < message.ksmAppShares.length; ++i) {
                    let error = $root.Vault.KsmChange.verify(message.ksmAppShares[i], long + 1);
                    if (error)
                        return "ksmAppShares." + error;
                }
            }
            if (message.ksmAppClients != null && Object.hasOwnProperty.call(message, "ksmAppClients")) {
                if (!Array.isArray(message.ksmAppClients))
                    return "ksmAppClients: array expected";
                for (let i = 0; i < message.ksmAppClients.length; ++i) {
                    let error = $root.Vault.KsmChange.verify(message.ksmAppClients[i], long + 1);
                    if (error)
                        return "ksmAppClients." + error;
                }
            }
            if (message.shareInvitations != null && Object.hasOwnProperty.call(message, "shareInvitations")) {
                if (!Array.isArray(message.shareInvitations))
                    return "shareInvitations: array expected";
                for (let i = 0; i < message.shareInvitations.length; ++i) {
                    let error = $root.Vault.ShareInvitation.verify(message.shareInvitations[i], long + 1);
                    if (error)
                        return "shareInvitations." + error;
                }
            }
            if (message.diagnostics != null && Object.hasOwnProperty.call(message, "diagnostics")) {
                let error = $root.Vault.SyncDiagnostics.verify(message.diagnostics, long + 1);
                if (error)
                    return "diagnostics." + error;
            }
            if (message.recordRotations != null && Object.hasOwnProperty.call(message, "recordRotations")) {
                if (!Array.isArray(message.recordRotations))
                    return "recordRotations: array expected";
                for (let i = 0; i < message.recordRotations.length; ++i) {
                    let error = $root.Vault.RecordRotation.verify(message.recordRotations[i], long + 1);
                    if (error)
                        return "recordRotations." + error;
                }
            }
            if (message.users != null && Object.hasOwnProperty.call(message, "users")) {
                ...
                for (let i = 0; i < message.users.length; ++i) {
                    let error = $root.Vault.User.verify(message.users[i], long + 1);
                    if (error)
                        return "users." + error;
                }
            }
            if (message.removedUsers != null && Object.hasOwnProperty.call(message, "removedUsers")) {
                if (!Array.isArray(message.removedUsers))
                    return "removedUsers: array expected";
                for (let i = 0; i < message.removedUsers.length; ++i)
                    if (!(message.removedUsers[i] && typeof message.removedUsers[i].length === "number" || $util.isString(message.removedUsers[i])))
                        return "removedUsers: buffer[] expected";
            }
            if (message.securityScoreData != null && Object.hasOwnProperty.call(message, "securityScoreData")) {
                if (!Array.isArray(message.securityScoreData))
                    return "securityScoreData: array expected";
                for (let i = 0; i < message.securityScoreData.length; ++i) {
                    let error = $root.Vault.SecurityScoreData.verify(message.securityScoreData[i], long + 1);
                    if (error)
                        return "securityScoreData." + error;
                }
            }
            if (message.notificationSync != null && Object.hasOwnProperty.call(message, "notificationSync")) {
                if (!Array.isArray(message.notificationSync))
                    return "notificationSync: array expected";
                for (let i = 0; i < message.notificationSync.length; ++i) {
                    let error = $root.NotificationCenter.NotificationWrapper.verify(message.notificationSync[i], long + 1);
                    if (error)
                        return "notificationSync." + error;
                }
            }
            if (message.keeperDriveData != null && Object.hasOwnProperty.call(message, "keeperDriveData")) {
                let error = $root.Vault.KeeperDriveData.verify(message.keeperDriveData, long + 1);
                if (error)
                    return "keeperDriveData." + error;
            }
            return null;
        };
    ...
    Vault.DriveRecord = (function() {
        ...
        /**
         * Encodes the specified DriveRecord message, length delimited. Does not implicitly {@link Vault.DriveRecord.verify|verify} messages.
         * @function encodeDelimited
         * @memberof Vault.DriveRecord
         * @static
         * @param {Vault.IDriveRecord} message DriveRecord message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DriveRecord.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
        ...
        /**
         * Decodes a DriveRecord message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof Vault.DriveRecord
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DriveRecord.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a DriveRecord message.
         * @function verify
         * @memberof Vault.DriveRecord
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        DriveRecord.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.thumbnailSize != null && Object.hasOwnProperty.call(message, "thumbnailSize"))
                if (!$util.isInteger(message.thumbnailSize) && !(message.thumbnailSize && $util.isInteger(message.thumbnailSize.low) && $util.isInteger(message.thumbnailSize.high)))
    ...
    Vault.FolderSharingState = (function() {
        ...
        /**
         * Encodes the specified FolderSharingState message, length delimited. Does not implicitly {@link Vault.FolderSharingState.verify|verify} messages.
         * @function encodeDelimited
         * @memberof Vault.FolderSharingState
         * @static
         * @param {Vault.IFolderSharingState} message FolderSharingState message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FolderSharingState.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
        ...
        /**
         * Decodes a FolderSharingState message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof Vault.FolderSharingState
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FolderSharingState.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a FolderSharingState message.
         * @function verify
         * @memberof Vault.FolderSharingState
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FolderSharingState.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.KeeperDriveData = (function() {
        ...
        /**
         * Encodes the specified KeeperDriveData message, length delimited. Does not implicitly {@link Vault.KeeperDriveData.verify|verify} messages.
         * @function encodeDelimited
         * @memberof Vault.KeeperDriveData
         * @static
         * @param {Vault.IKeeperDriveData} message KeeperDriveData message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        KeeperDriveData.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
        ...
        /**
         * Decodes a KeeperDriveData message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof Vault.KeeperDriveData
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        KeeperDriveData.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a KeeperDriveData message.
         * @function verify
         * @memberof Vault.KeeperDriveData
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        KeeperDriveData.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.folders != null && Object.hasOwnProperty.call(message, "folders")) {
                ...
                for (let i = 0; i < message.folders.length; ++i) {
                    let error = $root.Folder.FolderData.verify(message.folders[i], long + 1);
                    if (error)
                        return "folders." + error;
                }
            }
            if (message.folderKeys != null && Object.hasOwnProperty.call(message, "folderKeys")) {
                if (!Array.isArray(message.folderKeys))
                    return "folderKeys: array expected";
                for (let i = 0; i < message.folderKeys.length; ++i) {
                    let error = $root.Folder.FolderKey.verify(message.folderKeys[i], long + 1);
                    if (error)
                        return "folderKeys." + error;
                }
            }
            if (message.folderAccesses != null && Object.hasOwnProperty.call(message, "folderAccesses")) {
                if (!Array.isArray(message.folderAccesses))
                    return "folderAccesses: array expected";
                for (let i = 0; i < message.folderAccesses.length; ++i) {
                    let error = $root.Folder.FolderAccessData.verify(message.folderAccesses[i], long + 1);
                    if (error)
                        return "folderAccesses." + error;
                }
            }
            if (message.revokedFolderAccesses != null && Object.hasOwnProperty.call(message, "revokedFolderAccesses")) {
                if (!Array.isArray(message.revokedFolderAccesses))
                    return "revokedFolderAccesses: array expected";
                for (let i = 0; i < message.revokedFolderAccesses.length; ++i) {
                    let error = $root.Folder.RevokedAccess.verify(message.revokedFolderAccesses[i], long + 1);
                    if (error)
                        return "revokedFolderAccesses." + error;
                }
            }
            if (message.recordData != null && Object.hasOwnProperty.call(message, "recordData")) {
                if (!Array.isArray(message.recordData))
                    return "recordData: array expected";
                for (let i = 0; i < message.recordData.length; ++i) {
                    let error = $root.Folder.RecordData.verify(message.recordData[i], long + 1);
                    if (error)
                        return "recordData." + error;
                }
            }
            if (message.nonSharedData != null && Object.hasOwnProperty.call(message, "nonSharedData")) {
                if (!Array.isArray(message.nonSharedData))
            ...
            if (message.recordAccesses != null && Object.hasOwnProperty.call(message, "recordAccesses")) {
                if (!Array.isArray(message.recordAccesses))
                    return "recordAccesses: array expected";
                for (let i = 0; i < message.recordAccesses.length; ++i) {
                    let error = $root.Folder.RecordAccessData.verify(message.recordAccesses[i], long + 1);
                    if (error)
                        return "recordAccesses." + error;
                }
            }
            if (message.revokedRecordAccesses != null && Object.hasOwnProperty.call(message, "revokedRecordAccesses")) {
                if (!Array.isArray(message.revokedRecordAccesses))
                    return "revokedRecordAccesses: array expected";
                for (let i = 0; i < message.revokedRecordAccesses.length; ++i) {
                    let error = $root.record.v3.sharing.RevokedAccess.verify(message.revokedRecordAccesses[i], long + 1);
                    if (error)
                        return "revokedRecordAccesses." + error;
                }
            }
            if (message.recordSharingStates != null && Object.hasOwnProperty.call(message, "recordSharingStates")) {
                if (!Array.isArray(message.recordSharingStates))
                    return "recordSharingStates: array expected";
                for (let i = 0; i < message.recordSharingStates.length; ++i) {
                    let error = $root.record.v3.sharing.RecordSharingState.verify(message.recordSharingStates[i], long + 1);
                    if (error)
                        return "recordSharingStates." + error;
                }
            }
            if (message.recordLinks != null && Object.hasOwnProperty.call(message, "recordLinks")) {
                if (!Array.isArray(message.recordLinks))
            ...
            if (message.removedFolders != null && Object.hasOwnProperty.call(message, "removedFolders")) {
                if (!Array.isArray(message.removedFolders))
                    return "removedFolders: array expected";
                for (let i = 0; i < message.removedFolders.length; ++i) {
                    let error = $root.Folder.FolderRemoved.verify(message.removedFolders[i], long + 1);
                    if (error)
                        return "removedFolders." + error;
                }
            }
            if (message.removedFolderRecords != null && Object.hasOwnProperty.call(message, "removedFolderRecords")) {
                if (!Array.isArray(message.removedFolderRecords))
                    return "removedFolderRecords: array expected";
                for (let i = 0; i < message.removedFolderRecords.length; ++i) {
                    let error = $root.Records.FolderRecordKey.verify(message.removedFolderRecords[i], long + 1);
                    if (error)
                        return "removedFolderRecords." + error;
                }
            }
            if (message.folderRecords != null && Object.hasOwnProperty.call(message, "folderRecords")) {
                if (!Array.isArray(message.folderRecords))
                    return "folderRecords: array expected";
                for (let i = 0; i < message.folderRecords.length; ++i) {
                    let error = $root.Folder.FolderRecord.verify(message.folderRecords[i], long + 1);
                    if (error)
                        return "folderRecords." + error;
                }
            }
            if (message.recordRotationData != null && Object.hasOwnProperty.call(message, "recordRotationData")) {
                if (!Array.isArray(message.recordRotationData))
                    return "recordRotationData: array expected";
                for (let i = 0; i < message.recordRotationData.length; ++i) {
                    let error = $root.Vault.RecordRotation.verify(message.recordRotationData[i], long + 1);
                    if (error)
                        return "recordRotationData." + error;
                }
            }
            if (message.records != null && Object.hasOwnProperty.call(message, "records")) {
                if (!Array.isArray(message.records))
                    return "records: array expected";
                for (let i = 0; i < message.records.length; ++i) {
                    let error = $root.Vault.DriveRecord.verify(message.records[i], long + 1);
                    if (error)
                        return "records." + error;
                }
            }
            if (message.folderSharingState != null && Object.hasOwnProperty.call(message, "folderSharingState")) {
                if (!Array.isArray(message.folderSharingState))
                    return "folderSharingState: array expected";
                for (let i = 0; i < message.folderSharingState.length; ++i) {
                    let error = $root.Vault.FolderSharingState.verify(message.folderSharingState[i], long + 1);
                    if (error)
                        return "folderSharingState." + error;
                }
            }
            if (message.rawDagData != null && Object.hasOwnProperty.call(message, "rawDagData")) {
                if (!Array.isArray(message.rawDagData))
                    return "rawDagData: array expected";
                for (let i = 0; i < message.rawDagData.length; ++i) {
                    let error = $root.Dag.DebugData.verify(message.rawDagData[i], long + 1);
                    if (error)
                        return "rawDagData." + error;
                }
            }
            return null;
        };
    ...
    Vault.UserFolder = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        UserFolder.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserFolder.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        UserFolder.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.folderUid != null && Object.hasOwnProperty.call(message, "folderUid"))
                if (!(message.folderUid && typeof message.folderUid.length === "number" || $util.isString(message.folderUid)))
                    return "folderUid: buffer expected";
            if (message.parentUid != null && Object.hasOwnProperty.call(message, "parentUid"))
                if (!(message.parentUid && typeof message.parentUid.length === "number" || $util.isString(message.parentUid)))
                    return "parentUid: buffer expected";
            if (message.userFolderKey != null && Object.hasOwnProperty.call(message, "userFolderKey"))
                if (!(message.userFolderKey && typeof message.userFolderKey.length === "number" || $util.isString(message.userFolderKey)))
                    return "userFolderKey: buffer expected";
            if (message.keyType != null && Object.hasOwnProperty.call(message, "keyType"))
    ...
    Vault.SharedFolder = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SharedFolder.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SharedFolder.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolder.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.revision != null && Object.hasOwnProperty.call(message, "revision"))
                if (!$util.isInteger(message.revision) && !(message.revision && $util.isInteger(message.revision.low) && $util.isInteger(message.revision.high)))
                    return "revision: integer|Long expected";
            if (message.sharedFolderKey != null && Object.hasOwnProperty.call(message, "sharedFolderKey"))
                if (!(message.sharedFolderKey && typeof message.sharedFolderKey.length === "number" || $util.isString(message.sharedFolderKey)))
                    return "sharedFolderKey: buffer expected";
            if (message.keyType != null && Object.hasOwnProperty.call(message, "keyType"))
                switch (message.keyType) {
                default:
                    return "keyType: enum value expected";
            ...
            if (message.data != null && Object.hasOwnProperty.call(message, "data"))
                if (!(message.data && typeof message.data.length === "number" || $util.isString(message.data)))
                    return "data: buffer expected";
            if (message.defaultManageRecords != null && Object.hasOwnProperty.call(message, "defaultManageRecords"))
                if (typeof message.defaultManageRecords !== "boolean")
                    return "defaultManageRecords: boolean expected";
            if (message.defaultManageUsers != null && Object.hasOwnProperty.call(message, "defaultManageUsers"))
                if (typeof message.defaultManageUsers !== "boolean")
                    return "defaultManageUsers: boolean expected";
            if (message.defaultCanEdit != null && Object.hasOwnProperty.call(message, "defaultCanEdit"))
                if (typeof message.defaultCanEdit !== "boolean")
                    return "defaultCanEdit: boolean expected";
            if (message.defaultCanReshare != null && Object.hasOwnProperty.call(message, "defaultCanReshare"))
                if (typeof message.defaultCanReshare !== "boolean")
                    return "defaultCanReshare: boolean expected";
            if (message.cacheStatus != null && Object.hasOwnProperty.call(message, "cacheStatus"))
                switch (message.cacheStatus) {
                default:
                    return "cacheStatus: enum value expected";
            ...
            if (message.ownerAccountUid != null && Object.hasOwnProperty.call(message, "ownerAccountUid"))
                if (!(message.ownerAccountUid && typeof message.ownerAccountUid.length === "number" || $util.isString(message.ownerAccountUid)))
                    return "ownerAccountUid: buffer expected";
            if (message.name != null && Object.hasOwnProperty.call(message, "name"))
    ...
    Vault.UserFolderSharedFolder = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        UserFolderSharedFolder.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserFolderSharedFolder.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        UserFolderSharedFolder.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.SharedFolderFolder = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SharedFolderFolder.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SharedFolderFolder.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolderFolder.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.parentUid != null && Object.hasOwnProperty.call(message, "parentUid"))
                if (!(message.parentUid && typeof message.parentUid.length === "number" || $util.isString(message.parentUid)))
                    return "parentUid: buffer expected";
            if (message.sharedFolderFolderKey != null && Object.hasOwnProperty.call(message, "sharedFolderFolderKey"))
                if (!(message.sharedFolderFolderKey && typeof message.sharedFolderFolderKey.length === "number" || $util.isString(message.sharedFolderFolderKey)))
                    return "sharedFolderFolderKey: buffer expected";
            if (message.keyType != null && Object.hasOwnProperty.call(message, "keyType"))
                switch (message.keyType) {
                default:
                    return "keyType: enum value expected";
    ...
    Vault.SharedFolderKey = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SharedFolderKey.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SharedFolderKey.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolderKey.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.Team = (function() {
        ...
        Team.verify = function verify(message, long) {
            ...
            if (message.teamKey != null && Object.hasOwnProperty.call(message, "teamKey"))
                if (!(message.teamKey && typeof message.teamKey.length === "number" || $util.isString(message.teamKey)))
            ...
            if (message.teamPrivateKey != null && Object.hasOwnProperty.call(message, "teamPrivateKey"))
                if (!(message.teamPrivateKey && typeof message.teamPrivateKey.length === "number" || $util.isString(message.teamPrivateKey)))
                    return "teamPrivateKey: buffer expected";
            if (message.restrictEdit != null && Object.hasOwnProperty.call(message, "restrictEdit"))
                if (typeof message.restrictEdit !== "boolean")
                    return "restrictEdit: boolean expected";
            if (message.restrictShare != null && Object.hasOwnProperty.call(message, "restrictShare"))
                if (typeof message.restrictShare !== "boolean")
                    return "restrictShare: boolean expected";
            if (message.restrictView != null && Object.hasOwnProperty.call(message, "restrictView"))
                if (typeof message.restrictView !== "boolean")
                    return "restrictView: boolean expected";
            if (message.removedSharedFolders != null && Object.hasOwnProperty.call(message, "removedSharedFolders")) {
                if (!Array.isArray(message.removedSharedFolders))
                    return "removedSharedFolders: array expected";
                for (let i = 0; i < message.removedSharedFolders.length; ++i)
            ...
            if (message.sharedFolderKeys != null && Object.hasOwnProperty.call(message, "sharedFolderKeys")) {
                if (!Array.isArray(message.sharedFolderKeys))
                    return "sharedFolderKeys: array expected";
                for (let i = 0; i < message.sharedFolderKeys.length; ++i) {
                    let error = $root.Vault.SharedFolderKey.verify(message.sharedFolderKeys[i], long + 1);
                    if (error)
                        return "sharedFolderKeys." + error;
                }
            }
            if (message.teamEccPrivateKey != null && Object.hasOwnProperty.call(message, "teamEccPrivateKey"))
                if (!(message.teamEccPrivateKey && typeof message.teamEccPrivateKey.length === "number" || $util.isString(message.teamEccPrivateKey)))
                    return "teamEccPrivateKey: buffer expected";
            if (message.teamEccPublicKey != null && Object.hasOwnProperty.call(message, "teamEccPublicKey"))
                if (!(message.teamEccPublicKey && typeof message.teamEccPublicKey.length === "number" || $util.isString(message.teamEccPublicKey)))
                    return "teamEccPublicKey: buffer expected";
            return null;
        };
    ...
    Vault.Record = (function() {
        ...
        Record.verify = function verify(message, long) {
            ...
            if (message.udata != null && Object.hasOwnProperty.call(message, "udata"))
                if (!$util.isString(message.udata))
                    return "udata: string expected";
            if (message.fileSize != null && Object.hasOwnProperty.call(message, "fileSize"))
                if (!$util.isInteger(message.fileSize) && !(message.fileSize && $util.isInteger(message.fileSize.low) && $util.isInteger(message.fileSize.high)))
                    return "fileSize: integer|Long expected";
            if (message.thumbnailSize != null && Object.hasOwnProperty.call(message, "thumbnailSize"))
    ...
    Vault.RecordLink = (function() {
        ...
        RecordLink.verify = function verify(message, long) {
            ...
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.parentRecordUid != null && Object.hasOwnProperty.call(message, "parentRecordUid"))
                if (!(message.parentRecordUid && typeof message.parentRecordUid.length === "number" || $util.isString(message.parentRecordUid)))
                    return "parentRecordUid: buffer expected";
            if (message.childRecordUid != null && Object.hasOwnProperty.call(message, "childRecordUid"))
                if (!(message.childRecordUid && typeof message.childRecordUid.length === "number" || $util.isString(message.childRecordUid)))
                    return "childRecordUid: buffer expected";
            if (message.recordKey != null && Object.hasOwnProperty.call(message, "recordKey"))
    ...
    Vault.UserFolderRecord = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        UserFolderRecord.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserFolderRecord.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        UserFolderRecord.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.SharedFolderFolderRecord = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SharedFolderFolderRecord.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SharedFolderFolderRecord.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolderFolderRecord.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.NonSharedData = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        NonSharedData.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        NonSharedData.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        NonSharedData.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.RecordMetaData = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RecordMetaData.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RecordMetaData.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        RecordMetaData.verify = function verify(message, long) {
            ...
            if (message.expirationNotificationType != null && Object.hasOwnProperty.call(message, "expirationNotificationType"))
                switch (message.expirationNotificationType) {
                default:
                    return "expirationNotificationType: enum value expected";
                case 0:
                case 1:
                case 2:
                    break;
            ...
            if (message.ownerUsername != null && Object.hasOwnProperty.call(message, "ownerUsername"))
                if (!$util.isString(message.ownerUsername))
                    return "ownerUsername: string expected";
            return null;
        };
    ...
    Vault.SharingChange = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SharingChange.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SharingChange.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharingChange.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.ProfilePic = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ProfilePic.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ProfilePic.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ProfilePic.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.PendingTeamMember = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        PendingTeamMember.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        PendingTeamMember.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        PendingTeamMember.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.teamUids != null && Object.hasOwnProperty.call(message, "teamUids")) {
                if (!Array.isArray(message.teamUids))
                    return "teamUids: array expected";
                for (let i = 0; i < message.teamUids.length; ++i)
                    if (!(message.teamUids[i] && typeof message.teamUids[i].length === "number" || $util.isString(message.teamUids[i])))
                        return "teamUids: buffer[] expected";
            }
            if (message.userEccPublicKey != null && Object.hasOwnProperty.call(message, "userEccPublicKey"))
                if (!(message.userEccPublicKey && typeof message.userEccPublicKey.length === "number" || $util.isString(message.userEccPublicKey)))
                    return "userEccPublicKey: buffer expected";
            return null;
        };
    ...
    Vault.BreachWatchRecord = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        BreachWatchRecord.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        BreachWatchRecord.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        BreachWatchRecord.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.revision != null && Object.hasOwnProperty.call(message, "revision"))
                if (!$util.isInteger(message.revision) && !(message.revision && $util.isInteger(message.revision.low) && $util.isInteger(message.revision.high)))
                    return "revision: integer|Long expected";
            if (message.scannedByAccountUid != null && Object.hasOwnProperty.call(message, "scannedByAccountUid"))
                if (!(message.scannedByAccountUid && typeof message.scannedByAccountUid.length === "number" || $util.isString(message.scannedByAccountUid)))
                    return "scannedByAccountUid: buffer expected";
            return null;
        };
    ...
    Vault.UserAuth = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        UserAuth.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.BreachWatchSecurityData = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        BreachWatchSecurityData.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        BreachWatchSecurityData.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        BreachWatchSecurityData.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.ReusedPasswords = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ReusedPasswords.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ReusedPasswords.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ReusedPasswords.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.SharedFolderRecord = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolderRecord.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.SharedFolderUser = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolderUser.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.SharedFolderTeam = (function() {
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SharedFolderTeam.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.KsmChange = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        KsmChange.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        KsmChange.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        KsmChange.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.appRecordUid != null && Object.hasOwnProperty.call(message, "appRecordUid"))
                if (!(message.appRecordUid && typeof message.appRecordUid.length === "number" || $util.isString(message.appRecordUid)))
                    return "appRecordUid: buffer expected";
            if (message.detailId != null && Object.hasOwnProperty.call(message, "detailId"))
                if (!(message.detailId && typeof message.detailId.length === "number" || $util.isString(message.detailId)))
                    return "detailId: buffer expected";
            if (message.removed != null && Object.hasOwnProperty.call(message, "removed"))
                if (typeof message.removed !== "boolean")
                    return "removed: boolean expected";
            if (message.appClientType != null && Object.hasOwnProperty.call(message, "appClientType"))
                switch (message.appClientType) {
                default:
                    return "appClientType: enum value expected";
                case 0:
                case 1:
                case 2:
                case 3:
    ...
    Vault.ShareInvitation = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ShareInvitation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ShareInvitation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ShareInvitation.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.SyncDiagnostics = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SyncDiagnostics.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SyncDiagnostics.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SyncDiagnostics.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.enterpriseUserId != null && Object.hasOwnProperty.call(message, "enterpriseUserId"))
                if (!$util.isInteger(message.enterpriseUserId) && !(message.enterpriseUserId && $util.isInteger(message.enterpriseUserId.low) && $util.isInteger(message.enterpriseUserId.high)))
                    return "enterpriseUserId: integer|Long expected";
            if (message.syncedTo != null && Object.hasOwnProperty.call(message, "syncedTo"))
                if (!$util.isInteger(message.syncedTo) && !(message.syncedTo && $util.isInteger(message.syncedTo.low) && $util.isInteger(message.syncedTo.high)))
                    return "syncedTo: integer|Long expected";
            if (message.syncingTo != null && Object.hasOwnProperty.call(message, "syncingTo"))
                if (!$util.isInteger(message.syncingTo) && !(message.syncingTo && $util.isInteger(message.syncingTo.low) && $util.isInteger(message.syncingTo.high)))
                    return "syncingTo: integer|Long expected";
            return null;
        };
    ...
    Vault.RecordRotation = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RecordRotation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RecordRotation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        RecordRotation.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            ...
            if (message.lastRotation != null && Object.hasOwnProperty.call(message, "lastRotation"))
                if (!$util.isInteger(message.lastRotation) && !(message.lastRotation && $util.isInteger(message.lastRotation.low) && $util.isInteger(message.lastRotation.high)))
                    return "lastRotation: integer|Long expected";
            if (message.lastRotationStatus != null && Object.hasOwnProperty.call(message, "lastRotationStatus"))
                switch (message.lastRotationStatus) {
                default:
                    return "lastRotationStatus: enum value expected";
                case 0:
                case 1:
                case 2:
                case 3:
    ...
    Vault.BreachWatchGetSyncDataRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        BreachWatchGetSyncDataRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        BreachWatchGetSyncDataRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        BreachWatchGetSyncDataRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                return "maximum nesting depth exceeded";
            if (message.recordUids != null && Object.hasOwnProperty.call(message, "recordUids")) {
    ...
    Vault.BreachWatchGetSyncDataResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        BreachWatchGetSyncDataResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        BreachWatchGetSyncDataResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        BreachWatchGetSyncDataResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
    ...
    Vault.GetAccountUidMapResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GetAccountUidMapResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer && writer.len ? writer.fork() : writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GetAccountUidMapResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        GetAccountUidMapResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
