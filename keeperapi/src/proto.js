...
.addJSON({
    ...
    nested: {
      ...
      Settings: {
        fields: {
          ...
          shareDataKeyWithEccPublicKey: {
            type: "bool",
            id: 29
          },
          shareDataKeyWithDevicePublicKey: {
            type: "bool",
            id: 30
          },
          RecordTypesCounter: {
  ...
  Automator: {
    options: {
      java_package: "com.keepersecurity.proto",
      java_outer_classname: "Automator"
    },
    nested: {
      ...
      ApproveDeviceRequest: {
        fields: {
          ...
          ssoAuthenticationProtocolType: {
            type: "SsoAuthenticationProtocolType",
            id: 2
          },
          authMessage: {
            type: "string",
      ...
      AdminGetAutomatorsOnNodeRequest: {
        fields: {
          nodeId: {
            type: "int64",
            id: 1
  ...
  Tokens: {
    ...
    nested: {
      ...
      Position: {
        fields: {
          entity: {
            type: "Enterprise.EnterpriseDataEntity",
            id: 1
          },
          nodeId: {
            type: "int64",
      ...
      EnterpriseBackupContinuationToken: {
        fields: {
          backupKey: {
            type: "bytes",
            id: 1
          ...
          unlockPairs: {
            rule: "repeated",
            type: "EnterpriseBackupUnlockPair",
            id: 2
          },
          backupStage: {
            type: "EnterpriseBackupStage",
            id: 3
          },
          startUser: {
            type: "int64",
